						...
						<button className="btn button-1 d-flex justify-content-center align-items-center">
							<svg
								...
								<path
									...
									strokeWidth="1.5"
									d="M10.5 19.25c4.813 0 8.75-3.938 8.75-8.75 0-4.813-3.938-8.75-8.75-8.75-4.813 0-8.75 3.938-8.75 8.75 0 4.813 3.938 8.75 8.75 8.75zM7 10.5h7M10.5 14V7"></path>
							</svg>
							&nbsp; Create new Campaign
						</button>
					</Link>
						...
						<div className="search_main">
							<svg
								...
								<path
									...
									strokeLinejoin="round"
									strokeWidth="1.5"
									d="M11 20a9 9 0 100-18 9 9 0 000 18zM18.93 20.69c.53 1.6 1.74 1.76 2.67.36.85-1.28.29-2.33-1.25-2.33-1.14-.01-1.78.88-1.42 1.97z"></path>
							</svg>
							<input
								type="text"
